...
show_network_menu() {
    ...
    echo "2. NetworkManager problémák javítása (diagnosztika)"
    echo "3. NM konfigurációs fájlok javítása (törlés)"
    echo "4. Hálózati interfészek listázása (nmcli)"
